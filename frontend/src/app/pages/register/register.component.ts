    ...
    <div class="auth-page container animate-fade-in">
      <div class="auth-card glass">
        <div class="auth-header">
          <h1 class="font-display text-gradient">Rejoindre</h1>
          <p class="auth-subtitle">Devenez membre de l'élite cinématographique.</p>
        </div>
        ...
        <form [formGroup]="form" (ngSubmit)="submit()" class="auth-form">
          <div class="form-group">
            ...
            <div class="input-wrapper">
              <input formControlName="login" type="text" placeholder="Choisissez un identifiant" autocomplete="username" class="modern-input" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              <input formControlName="password" type="password" placeholder="••••••••" autocomplete="new-password" class="modern-input" />
            </div>
          </div>

          <button type="submit" class="btn btn-primary full-width" [disabled]="form.invalid || loading">
            <span *ngIf="!loading">Créer mon profil</span>
            <span *ngIf="loading" class="loader-dots">Initialisation...</span>
          </button>
        </form>

        <div class="auth-footer">
          <span class="muted">Déjà membre ?</span>
